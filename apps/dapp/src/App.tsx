      ...
      <main className="relative z-10 max-w-6xl mx-auto px-4 py-8 space-y-8">
        ...
        >
          ...
          <p className="text-btc-muted text-lg max-w-xl mx-auto">
            Take a selfie, let AI score your smile, and claim Rune tokens from
            the community pool. Powered by Midl Protocol.
          </p>
        </motion.section>
